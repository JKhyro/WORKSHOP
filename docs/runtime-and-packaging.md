...
## Local offer launch delivery expansion-growth-plan acceptance slice

- Native C now validates
  `WorkshopOfferLaunchDeliveryExpansionGrowthPlanAcceptance` as App-internal
  next-service acceptance state after a customer-safe expansion-growth-plan
  receipt and
  `WorkshopOfferLaunchDeliveryExpansionGrowthPlanAcceptanceReceipt` as the
  customer-safe expansion-growth-plan acceptance status export.
- The Avalonia App persists
  `offer-launch-delivery-expansion-growth-plan-acceptances.json` after a
  customer-safe delivery expansion-growth-plan receipt is ready, then persists
  `offer-launch-delivery-expansion-growth-plan-acceptance-receipts.json` for
  Webportal-safe repeat-service, renewal, or referral acceptance status.
- The static App mirrors the same chain with delivery expansion-growth-plan
  acceptance counters and internal acceptance/receipt lists, and the launch
  intake action flow now continues from expansion growth plan into an
  App-owned expansion growth-plan acceptance before exposing only the
  customer-safe receipt.
- The Webportal can import only App-exported
  `offer-launch-delivery-expansion-growth-plan-acceptance-receipts.json`
  records. The normalizer rejects expansion-growth-plan receipt provenance,
  expansion-growth-plan acceptance ids, expansion-growth-plan ids,
  expansion-follow-up/outcome/milestone/kickoff/workspace/request ids,
  acceptance/growth/follow-up/outcome/milestone/kickoff/workspace/setup/
  activation/intake provenance, launch readiness ids, experiment ids,
  marketing channel ids, launch scores, provider go-live flags, payment flags,
  live-provider flags, MONITOR/control flags, and operator controls before
  rendering customer-safe expansion-growth-plan acceptance status.
- EPOCH remains timing-provider-only. WORKSHOP owns expansion-growth-plan
