...
function handleOfferLaunchIntakeAction(event) {
  ...
  if (confirmation) confirmation.textContent = deliveryExpansionWorkspaceReceipt.customerSafeMessage;
  form.reset();
  renderAll();
}
