...
function handleOfferLaunchIntakeAction(event) {
  ...
  if (confirmation) confirmation.textContent = deliveryExpansionMilestoneReceipt.customerSafeMessage;
  form.reset();
  renderAll();
}
