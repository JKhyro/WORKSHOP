...
function handleOfferLaunchIntakeAction(event) {
  ...
  if (confirmation) confirmation.textContent = deliveryExpansionRequestReceipt.customerSafeMessage;
  form.reset();
  renderAll();
}
