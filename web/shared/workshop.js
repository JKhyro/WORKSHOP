...
function handleOfferLaunchIntakeAction(event) {
  ...
  if (confirmation) confirmation.textContent = deliveryExpansionKickoffReceipt.customerSafeMessage;
  form.reset();
  renderAll();
}
