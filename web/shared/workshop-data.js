...
export const initialWorkshopLedger = {
  ...
  servicePages: [
    {
      ...
      deliveryType: "async-submission-review",
      priceLabel: "JPY 16,000 / 4 submissions",
      intakeFormKey: "submission-review-request",
      publicStatus: "ready",
      japanCopyMode: "ai-neutral",
      aiForwardCopy: false,
      appOwnedServicePageState: true,
      customerVisible: true,
    ...
    },
    {
      ...
      deliveryType: "scoped-systems-review",
      priceLabel: "Scoped quote after fit review",
      intakeFormKey: "systems-review-request",
  ...
  materialAssets: [
    {
      ...
      appOwnedMaterialAssetState: true,
      webportalExportReady: false,
      ...
      operatorNextAction: "Keep the rubric App-owned, reuse it for adult submission review, and require human review before customer-facing corrections leave WORKSHOP."
    },
    {
      id: "material-asset-crm-cleanup-checklist-001",
      title: "Small Operator CRM Cleanup Checklist",
      assetKind: "checklist",
      assetFormat: "delivery-checklist",
      linkedOfferId: "offer-experiment-systems-001",
      linkedServicePageId: "service-page-systems-001",
      reuseCount: 3,
      expectedTimeSavedMinutes: 120,
      materialAssetReady: true,
      customerVisible: false,
      araDraftReady: true,
      humanReviewRequired: true,
      ...
      operatorNextAction: "Keep the checklist App-owned until the systems offer has a repeatable fit-review boundary and customer-safe service page path."
    }
  ],
  marketingChannelExperiments: [
    {
      ...
      marketingChannelExperimentReady: true,
  ...
  cohortPlans: [
    ...
    },
    {
      ...
      recurringStatus: "not-required",
      nextServiceWindow: "no live timing required",
      exceptionCount: 0,
  ...
  cohortCapacityPlans: [
    {
      ...
      customerVisible: true,
      appOwnedCohortCapacityPlanState: true,
      webportalExportReady: true,
      epochTimingProviderOnly: true,
      workshopCalendarOwnership: false,
      monitorWorkflowExposed: false,
  ...
  subscriptionPlans: [
    {
      ...
      appOwnedSubscriptionPlanState: true,
      webportalExportReady: true,
      epochTimingProviderOnly: true,
      workshopCalendarOwnership: false,
      monitorWorkflowExposed: false,
